                        ...
                        <div class="card-header py-3">
                            <div class="row">
                                <div class="col-6 col-sm-6">
                                    <h3 class="m-0 font-weight-bold text-primary">Quản lí kho sách</h3>
                                </div>
                                <div class="col-6">
                                    <form action="#">
                                        <div class="row">
                                            <div class="col-9 pr-1">
                                                <div class="form-group">
                                                    <input type="text" name="keyword" id="search" class="form-control form-control-user" placeholder="search">
                                                </div>
                                            </div>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    for (int i = 0; i < books.size(); i++) {%>
                                        <tr>
                                            ...
                                            <td><%=books.get(i).getAuthor().getName() %></td>
                                            <td><%=books.get(i).getCategory().getName() %></td>
                                            <td>
			                                    <a href="register?action=detail&id=<%=books.get(i).getId() %>"><span class="m-2 fa-bk"><i class="fas fa-check-circle "></i></span></a>
			                                </td>
                                        </tr>
                                        <%} %>
                                    </tbody>
