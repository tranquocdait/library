...
@WebServlet(value = "/managerBorrowBook")
public class ManagerBooKController extends HttpServlet {
	...
	private void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("bookManagers", bookManagerService.findAll());
		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/managerbook.jsp");
